...
Dr. Yevgeniy, Dr. Leszczynskiに感謝いたします。
<br/>

補足情報：2020年06月08日更新  
MaSKの入手ページは、2020年5月20日にドメインの期限が切れ、更新または削除が保留されている状態です。リポジトリ、ホスティングサービスやWebアーカイブ等からも入手することができません。  

ご迷惑をおかけしますが、代替ソフトについては、本書の中で適時説明しておりますので、 そちらをご参照いただきますようお願い致します。  
元よりMacユーザーはMaSKが使用できないので、その都度他の代替ソフトを提案する形で補足しております。  
今後のMaSKの更新情報については、本サポートページで分かり次第ご報告いたします。  
<br/>
...
<br/>
その他、ver.1.00 (初版)の誤りは既に修正されております。  
以前のVerをご購入頂いている方も、無料で最新版に更新することが可能です。  
<br/>
