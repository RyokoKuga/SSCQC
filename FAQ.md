...
本書を読了後、各バージョンの[変更履歴](https://www.msg.chem.iastate.edu/gamess/versions.html)を確認し、ご自身の業務にどうしても必要な場合などに導入をご検討ください。初心者で、とにかく最新のバージョンを使いたがる方がいますが、専門家でないかぎり、最新のものはバグなどを含む可能性があるので、できるだけ安定したバージョンを選ぶようにしましょう。
