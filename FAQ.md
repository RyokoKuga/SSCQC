...
本書では、GAMESS(US)「Ver. Aug 18, 2016」の使用を推奨しています。「June 30, 2020 R1」以降のバージョンは、MoCalc2012(ver4.2.0.3)と上手く連携・実行できないようなので、推奨しません。「June 30, 2020 R1」以降のバージョンは、それ以前のバージョンから特に初心者の方が扱うような新しい機能などは追加されていません。  
