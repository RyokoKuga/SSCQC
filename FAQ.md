...
2023年6月8日時点で、サイトのドメイン期限が切れてダウンロードできない状況が確認されています。現在の状況が、一時的なものかどうかは不明ですが、しばらく経っても改善されないようであれば製作者(Dr.Yevgeniy Podolyan(Jackson State University))に問い合わせて確認後、状況を更新いたします。サイトの復旧が確認されるまでは、ご不便とは思いますがMoCalc2012などで代替をご検討ください。  
