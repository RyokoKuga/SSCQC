...
本書では、GAMESS(US)「Ver. Aug 18, 2016」を使用して解説しております。「June 30, 2020 R1」以降のバージョンは、MoCalc2012(ver4.2.0.3)と上手く連携・実行できないようなので、本書で学習を進める上では推奨しません。「June 30, 2020 R1」以降のバージョンは、それ以前のバージョンから特に初心者の方が扱うような新しい機能などは追加されていません。  

本書を読了後、最新のバージョンの[変更履歴](https://www.msg.chem.iastate.edu/gamess/versions.html)を確認し、ご自身の業務にどうしても必要な場合などに導入をご検討ください。初心者で、とにかく最新のバージョンを使いたがる方がいますが、専門家でないかぎり、最新のものはバグなどを含む可能性があるので、できるだけ安定したバージョンを選ぶようにしましょう。

もし、MoCalc2012(ver4.2.0.3)で利用可能な「Ver. June 30, 2019 R1」を使用したい場合は、連携するのに少し工夫が必要です。  
...
[2025年以降に本書をご購入された方へ](https://github.com/RyokoKuga/SSCQC/blob/master/Af2025.md)  
